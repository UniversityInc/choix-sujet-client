 ...
 * 
 */
@WebServiceClient(name = "UtilisateurService", targetNamespace = "http://webservices.com/", wsdlLocation = "http://desktop-341sj7p:8080/choixsujetws/UtilisateurService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName UTILISATEURSERVICE_QNAME = new QName("http://webservices.com/", "UtilisateurService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://desktop-341sj7p:8080/choixsujetws/UtilisateurService?wsdl");
    ...
    public Utilisateur getUtilisateurPort() {
        return super.getPort(new QName("http://webservices.com/", "UtilisateurPort"), Utilisateur.class);
    }
    ...
    public Utilisateur getUtilisateurPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.com/", "UtilisateurPort"), Utilisateur.class, features);
    }
